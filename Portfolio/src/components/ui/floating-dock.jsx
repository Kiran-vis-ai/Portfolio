...
function IconContainer({ mouseX, title, icon, href, download }) {
  let ref = useRef(null);
        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="absolute left-1/2 top-full mt-2 w-fit rounded-md border border-transparent bg-transparent px-2 py-0.5 text-xs whitespace-pre text-white"
            >
              {title}
            </motion.div>
          )}
